    ...
    <div class="box box-widget widget-user">
        <div class="widget-user-header bg-blue-active">
            <p style="text-align: center;">
                <span style="font-family: georgia, palatino; font-size: 14pt;">Selamat datang di Sistem Presensi Karyawan Dinas Pariwisata Garut</span>
            </p>
            <h3 class="widget-user-username"></h3>
            <h5 class="widget-user-desc"></h5>
        </div>
        <div class="widget-user-image">
            <img src="<?php echo base_url() ?>assets/dist/img/photo2.jpg" alt="User Avatar">
        </div>
        <div class="box-footer">
            <div class="row">
                ...
                <div class="col-sm-4 border-right">
                    ...
                    <center>
                        <i>Sistem Presensi Karyawan Dinas Pariwisata Garut</i><br>
